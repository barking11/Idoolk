 ...
 */
- (void)unifiedInterstitialAdDidRewardEffective:(GDTUnifiedInterstitialAd *)unifiedInterstitial info:(NSDictionary *)info GDT_DEPRECATED_MSG_ATTRIBUTE("接口即将废弃，请使用 gdt_adDidRewardEffective:info:");

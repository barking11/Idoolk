...
/**
 ...
 @param rewardedVideoAd GDTRewardVideoAd 实例
 */
- (void)gdt_rewardVideoAdDidRewardEffective:(GDTRewardVideoAd *)rewardedVideoAd GDT_DEPRECATED_MSG_ATTRIBUTE("接口即将废弃，请使用 gdt_adDidRewardEffective:info:");
 ...
 */
- (void)gdt_rewardVideoAdDidRewardEffective:(GDTRewardVideoAd *)rewardedVideoAd info:(NSDictionary *)info GDT_DEPRECATED_MSG_ATTRIBUTE("接口即将废弃，请使用 gdt_adDidRewardEffective:info:");
